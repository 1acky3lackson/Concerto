...
public class HttpRequestBuilder {
    ...
    public static Supplier<Boolean> PRINT_REQUEST_RESULTS_SUPPLIER = () -> false;
    ...
    public HttpResponse<InputStream> openStream() {
        ...
        String logUrl = CommonTextUtil.maskUrl(this.url);
        try {
    ...
    public <T> HttpResponse<T> get(HttpResponse.BodyHandler<T> bodyHandler) {
        ...
        try {
            ...
            if (PRINT_REQUEST_RESULTS_SUPPLIER.get() && bodyHandler == HttpResponse.BodyHandlers.ofString()) {
