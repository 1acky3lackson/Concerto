...
public class QQMusicApiClient extends HttpApiClient {
    ...
    public Pair<String, String> getMusicLink(String mid, String mediaMid) {
        try {
            ...
            ConcertoCommon.getPlatform().getLogger().warn("Got empty link for QQ Music {}", mid);
            return Pair.of("", "");
        } catch (IOException | URISyntaxException e) {
            ConcertoCommon.getPlatform().getLogger().error("Error getting music link", e);
    ...
    public Pair<String, String> getLyrics(String mid) {
        String url = "https://c.y.qq.com/lyric/fcgi-bin/fcg_query_lyric_new.fcg?callback=MusicJsonCallback_lrc&pcachetime=" + CommonTextUtil.getCurrentTime() + "&songmid=" + mid + "&g_tk=5381&jsonpCallback=MusicJsonCallback_lrc&loginUin=0&hostUin=0&format=jsonp&inCharset=utf8&outCharset=utf-8&platform=yqq&needNewCode=0";
        ...
        return Pair.of(CommonTextUtil.fromBase64(object.get("lyric").getAsString()), CommonTextUtil.fromBase64(object.get("trans").getAsString()));
    }
    ...
    public String getWeChatQRKey() {
        ...
        return matcher.group(1) + ":" + CommonTextUtil.getCurrentTime();
    }
    ...
    public String combineWeChatQRLink(String key) {
        try {
            ...
            ConcertoCommon.getPlatform().getLogger().warn("Error while combining WeChat QR link", e);
            return "error";
        }
    }
    ...
    public JsonObject search(String keyword, SearchType type, int page) {
        try {
            ...
            ConcertoCommon.getPlatform().getLogger().warn("Error searching for music {}", keyword, e);
            return null;
        }
    }
    ...
    public JsonObject requestSignedApi(String module, String method, String params) throws IOException, URISyntaxException {
        ...
        String url = "https://u.y.qq.com/cgi-bin/musics.fcg?_=" + CommonTextUtil.getCurrentTime() + "&sign=" + QQMusicApiEncrypt.Sign.getSign(data);
