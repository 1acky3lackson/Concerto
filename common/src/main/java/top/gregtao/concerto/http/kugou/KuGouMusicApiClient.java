...
public class KuGouMusicApiClient extends HttpApiClient {
    ...
    public static Supplier<Boolean> LITE_SUPPLIER = () -> false;
    ...
    public void writeCookie() {
        String cookies = CommonTextUtil.toBase64("https://www.kugou.com") + ":"
                + COOKIES.entrySet().stream()
                    .map(entry -> entry.getKey() + "=" + entry.getValue())
                    .reduce((a, b) -> a + "\n" + b)
                    .map(CommonTextUtil::toBase64)
                    .orElse("");
    ...
    public Optional<JsonObject> getSongUrl(String hash, boolean isFreePart) {
        boolean isLite = LITE_SUPPLIER.get();
    ...
    public Optional<JsonObject> getPlayListAllTrack(String id) {
        ...
        Map<String, String> paramsMap = Map.of(
                ...
                "personal_switch", "1",
                "extend_fields", "",
                "pagesize", String.valueOf(NeteaseCloudApiClient.MAX_PLAYLIST_SIZE),
    ...
    public Optional<JsonObject> receiveVip() {
        ...
        if (!LITE_SUPPLIER.get()) return Optional.empty();
    ...
    public String getUseAppid() {
        return LITE_SUPPLIER.get() ? LITE_APPID : APPID;
    }

    public String getUseClientVer() {
        return LITE_SUPPLIER.get() ? LITE_CLIENT_VER : CLIENT_VER;
    }
    ...
    public String getKey() {
        return LITE_SUPPLIER.get() ? LITE_KEY : KEY;
    }

    public String getIv() {
        return LITE_SUPPLIER.get() ? LITE_IV : IV;
    }
